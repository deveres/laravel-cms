...
class LangsCatsBackendController extends BackendController
{
    ...
    protected function grid()
    {
        ...
        $grid->name('Название')->treeName(
            $grid,
            config('admin.route.prefix').'.langs_labels.index',
            'labels_tree'
        ...
        $grid->ord1(' ')->rowOrderable($grid, route(config('admin.route.prefix').'.row-orderable'))->setAttributes(['style' => 'width:20px;']);
