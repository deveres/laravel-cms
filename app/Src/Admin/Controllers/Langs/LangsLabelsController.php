...
use App\Src\Admin\Extensions\Tools\CreateLabels;
use App\Src\Admin\Widgets\FilterTree;
...
class LangsLabelsController extends Controller
{
    ...
    protected function grid()
    {
        ...
        if ($can_create) {
            $grid->tools(function ($tools) {
                $tools->append(new CreateLabels(request('labels_tree', 0)));
            });
        }
