...
use App\Src\Admin\Extensions\Grid\Tools\SynchroLabelsGridTool;
...
class LangsBackendController extends BackendController
{
    ...
    protected function grid()
    {
        ...
        $grid->tools(function ($tools) use ($can_edit) {
            if ($can_edit) {
                $tools->append(new SynchroLabelsGridTool());
            }
        });
